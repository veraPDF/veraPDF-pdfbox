...
public class TestHexStringsParse extends BaseTest{
	...
	@Test
	public void testOddHexString() throws IOException {
		COSString string = getCosString("6-1-6-t01-fail-a.pdf");
		Assert.assertTrue(string.getHexCount() % 2 != 0);
	}

	@Test
	public void testIsHexSymbols() throws IOException {
	...
	private COSString getCosString(String name) throws IOException {
