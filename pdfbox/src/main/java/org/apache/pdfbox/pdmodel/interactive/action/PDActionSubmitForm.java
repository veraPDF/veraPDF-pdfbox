...
public class PDActionSubmitForm extends PDAction {
	...
	/**
	 * An array identifying which fields to include in the submission
	 * or which to exclude, depending on the setting of the
	 * Include/Exclude flag in the Flags entry
	 *
